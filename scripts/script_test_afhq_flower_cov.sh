...
method=flower_m2
problem=inpainting
python main.py --opts dataset ${dataset} eval_split ${eval_split} model ${model} problem ${problem} method ${method} num_samples 1 max_batch ${max_batch} batch_size_ip ${batch_size_ip} steps 40 device cuda:3